...
_RPC_METHOD_DESCRIPTORS = (
    ...
    _rpc(
        "channel.status",
        api_schema.ChannelStatusParams,
        _schema_result("ChannelStatusResult"),
        True,
        RpcHandlerGroup.ADMIN,
    ...
    _rpc(
        "channel.test",
        api_schema.ChannelTestParams,
        _schema_result("ChannelTestResult"),
        True,
        RpcHandlerGroup.ADMIN,
        "handle_channel_test",
    ),
    _rpc(
        ...
        api_schema.ChannelPairingListParams,
        _schema_result("ChannelPairingListResult"),
        True,
        RpcHandlerGroup.ADMIN,
        "handle_channel_pairing_list",
    ),
    _rpc(
        "channel.pairing_cleanup",
        api_schema.ChannelPairingCleanupParams,
        _schema_result("ChannelPairingCleanupResult"),
        True,
        RpcHandlerGroup.ADMIN,
        "handle_channel_pairing_cleanup",
    ),
    _rpc(
