...
def _method_specs(
    ...
    *,
    ...
    specs: list[tuple[str, Any, bool, type[BaseModel]]] = [
        ...
        ("plan.steps", handlers.handle_plan_steps, False, PlanStepsParams),
        ...
        ("graph.query", handlers.handle_graph_query, False, GraphQueryParams),
        ("graph.export", handlers.handle_graph_export, False, GraphExportParams),
        (
            "memory.consolidate",
            handlers.handle_memory_consolidate,
            True,
            MemoryConsolidateParams,
        ),
        (
        ...
        (
            ...
            handlers.handle_memory_timeline_search,
            False,
            MemoryTimelineSearchParams,
        ),
        (
            "memory.timeline.read",
            handlers.handle_memory_timeline_read,
            False,
            MemoryTimelineReadParams,
        ),
        (
            "memory.timeline.promote",
            handlers.handle_memory_timeline_promote,
            True,
            MemoryTimelinePromoteParams,
        ),
        ...
        (
            ...
            handlers.handle_memory_ingest_procedure_candidate,
            True,
            MemoryIngestProcedureCandidateParams,
        ),
        (
        ...
        (
            ...
            handlers.handle_memory_reject_procedure_candidate,
            True,
            MemoryRejectProcedureCandidateParams,
        ),
        (
            "memory.promote_procedure_candidate",
            handlers.handle_memory_promote_procedure_candidate,
            True,
            MemoryPromoteProcedureCandidateParams,
        ),
        (
        ...
        (
            ...
            handlers.handle_memory_read_original,
            False,
            MemoryReadOriginalParams,
        ),
        ...
        ("thread.list", handlers.handle_thread_list, False, ThreadListParams),
        ("thread.inspect", handlers.handle_thread_inspect, False, ThreadEntryParams),
        ("thread.resume", handlers.handle_thread_resume, True, ThreadEntryParams),
        ("thread.close", handlers.handle_thread_close, True, ThreadCloseParams),
        ("thread.why", handlers.handle_thread_why, False, ThreadWhyParams),
        ...
        (
            ...
            handlers.handle_task_status_snapshot,
            False,
            TaskStatusSnapshotParams,
        ),
