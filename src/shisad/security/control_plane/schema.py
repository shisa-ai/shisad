...
_TOOL_KIND_MAP: dict[str, ActionKind] = {
    ...
    "thread.list": ActionKind.MEMORY_READ,
    "thread.inspect": ActionKind.MEMORY_READ,
    "thread.resume": ActionKind.MEMORY_WRITE,
    "thread.close": ActionKind.MEMORY_WRITE,
    "thread.why": ActionKind.MEMORY_READ,
