...
`v0.7.0` (GitHub Release and PyPI package), which adds structured long-term
memory with separate identity, active-attention, recall, procedural-skill, and
evidence surfaces; review-gated memory writes; and derived
graph/consolidation foundations.

| Version | Focus |
|---------|-------|
| **v0.7** | **Memory foundation + long-term memory surfaces (current published line: `v0.7.0`)** |
